...
module.exports = Object.freeze({
  ...
  siteMetadata: {
    ...
    description:
      'Go Apply is a community where developers discover meaningful software projects and help each other build and ship them.',
    /** The url of the website. */
    siteUrl: process.env.BUILD_SITE_URL,
    logo: path.resolve(__dirname, 'src/images/logo.png'),
    /*Email displayed on static pages */
    contactEmail: 'goapply@cameronbrill.me',
    /*Email displayed on static pages */
