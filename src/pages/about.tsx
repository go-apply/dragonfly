  ...
  return (
    <Layout>
      ...
      <Container>
        ...
        <PageBody>
          <p>
            Go Apply is a virtual co-working space of software developers from
            around the world working together to create and deploy meaningful
            software.
          </p>
          <p>
            Our mission is to foster a community where creative individuals can
            collaborate together to build real world applications. By joining Go
            Apply we hope that we can help improve your technical,
            communication, management and leadership skills while working
            collaboratively with other members of the community. Go Apply
